...
void
runAutostart(void) {
	system("cd ~/.config/startup; ./autostart_blocking.sh");
	system("cd ~/.config/startup; ./autostart.sh &");
}
...
/* Using vanitygaps functions instead of default layouts */
